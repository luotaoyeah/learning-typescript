...
addEvent(document.getElementById('productId')!, 'keyup', function (this: HTMLInputElement) {
...
let id = 4;
addEvent(document.getElementById('btnAddProduct')!, 'click', function (this: HTMLButtonElement) {
  productDatabase.addProduct(new Product(id++, 'DD'));
});

addEvent(document.getElementById('btnDeleteProduct')!, 'click', function (this: HTMLButtonElement) {
